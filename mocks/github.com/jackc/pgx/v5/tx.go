...
func (_m *Tx) Exec(ctx context.Context, sql string, arguments ...any) (pgconn.CommandTag, error) {
	var _ca []interface{}
...
func (_c *Tx_Exec_Call) RunAndReturn(run func(context.Context, string, ...any) (pgconn.CommandTag, error)) *Tx_Exec_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Tx) Query(ctx context.Context, sql string, args ...any) (pgx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_c *Tx_Query_Call) RunAndReturn(run func(context.Context, string, ...any) (pgx.Rows, error)) *Tx_Query_Call {
	_c.Call.Return(run)
	return _c
}

// QueryRow provides a mock function with given fields: ctx, sql, args
func (_m *Tx) QueryRow(ctx context.Context, sql string, args ...any) pgx.Row {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_c *Tx_QueryRow_Call) RunAndReturn(run func(context.Context, string, ...any) pgx.Row) *Tx_QueryRow_Call {
	_c.Call.Return(run)
	return _c
}
