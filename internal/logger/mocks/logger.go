...
import (
	...
	logger "github.com/clevertechware/handling-db-transactions-in-golang/internal/logger"
...
func (_c *Logger_Debug_Call) RunAndReturn(run func(string, ...any)) *Logger_Debug_Call {
	_c.Run(run)
	return _c
}

// DebugContext provides a mock function with given fields: ctx, msg, args
func (_m *Logger) DebugContext(ctx context.Context, msg string, args ...any) {
	var _ca []interface{}
...
func (_c *Logger_DebugContext_Call) RunAndReturn(run func(context.Context, string, ...any)) *Logger_DebugContext_Call {
	_c.Run(run)
	return _c
}
...
func (_c *Logger_Error_Call) RunAndReturn(run func(string, ...any)) *Logger_Error_Call {
	_c.Run(run)
	return _c
}

// ErrorContext provides a mock function with given fields: ctx, msg, args
func (_m *Logger) ErrorContext(ctx context.Context, msg string, args ...any) {
	var _ca []interface{}
	_ca = append(_ca, ctx, msg)
	_ca = append(_ca, args...)
	_m.Called(_ca...)
...
func (_c *Logger_ErrorContext_Call) RunAndReturn(run func(context.Context, string, ...any)) *Logger_ErrorContext_Call {
	_c.Run(run)
	return _c
}
...
func (_c *Logger_Info_Call) RunAndReturn(run func(string, ...any)) *Logger_Info_Call {
	_c.Run(run)
	return _c
}

// InfoContext provides a mock function with given fields: ctx, msg, args
func (_m *Logger) InfoContext(ctx context.Context, msg string, args ...any) {
	var _ca []interface{}
	_ca = append(_ca, ctx, msg)
	_ca = append(_ca, args...)
	_m.Called(_ca...)
...
func (_c *Logger_InfoContext_Call) RunAndReturn(run func(context.Context, string, ...any)) *Logger_InfoContext_Call {
	_c.Run(run)
	return _c
}
...
func (_c *Logger_Warn_Call) RunAndReturn(run func(string, ...any)) *Logger_Warn_Call {
	_c.Run(run)
	return _c
}

// WarnContext provides a mock function with given fields: ctx, msg, args
func (_m *Logger) WarnContext(ctx context.Context, msg string, args ...any) {
	var _ca []interface{}
	_ca = append(_ca, ctx, msg)
	_ca = append(_ca, args...)
	_m.Called(_ca...)
...
func (_c *Logger_WarnContext_Call) RunAndReturn(run func(context.Context, string, ...any)) *Logger_WarnContext_Call {
	_c.Run(run)
	return _c
}

// With provides a mock function with given fields: args
func (_m *Logger) With(args ...any) logger.Logger {
	var _ca []interface{}
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
	...
	if rf, ok := ret.Get(0).(func(...any) logger.Logger); ok {
		r0 = rf(args...)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Logger_With_Call) RunAndReturn(run func(...any) logger.Logger) *Logger_With_Call {
	_c.Call.Return(run)
	return _c
}
